  ...
  return (
    <div className="space-y-3">
      <input
        ...
        className="block w-full text-sm text-zinc-400 file:mr-4 file:px-4 file:py-2 file:rounded-lg file:border-0 file:bg-violeta-app file:text-[#1c1c21] file:font-medium file:cursor-pointer hover:file:bg-violeta-app/90 file:transition-colors disabled:opacity-50"
      />
